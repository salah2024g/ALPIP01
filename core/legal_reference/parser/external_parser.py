from core.legal_reference.models.external_reference import ExternalReference
    ...
    def parse(self, text: str):
        ...
        for match in LAW_PATTERN.finditer(text):
            references.append(
                ExternalReference(
                    reference_type="law",
                    law_number=normalize_number(match.group(1)),
                    year=normalize_number(match.group(2)),
